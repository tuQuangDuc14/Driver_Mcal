TEST_NAME_DESCRIPTION = "Test Master send receive interrupt"
LIST_TC_OF_TS = ['I2c_TC_001']
LIST_TC_DESCRIPTION = ['Test Master send receive interrupt']

LIST_MODULE_RELATED = ['Gpio', 'Mcu']
...
XDM_FILES = [
    ...
    f'{TEST_DIR}/{TEST_NAME}/config/Mcu.xdm',
